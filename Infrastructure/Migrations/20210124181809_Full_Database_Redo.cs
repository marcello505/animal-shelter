...
{
    public partial class Full_Database_Redo : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Animal1 = table.Column<int>(nullable: true),
                    Animal2 = table.Column<int>(nullable: true),
                    Animal3 = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
